...
verify($manifest->data['plugin_version'] === '0.3.0', 'Current connector contract version exposed');
...
echo "PASS: 18 WordPress permission/capability/inventory assertions (stub harness).\n";
